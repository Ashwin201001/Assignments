...
import 'C:\\Users\\ashwin.sv\\Downloads\\Frontend\\src\\styles\\lifecycleventmanagementpage.css';
    ...
    <div className="container">
      ...
      <div className="card card-container">
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn btn-primary" style={{ backgroundColor: "rgb(132, 194, 215)", border: "#26A69A" }}>Add Event</button>
        </form>
      </div>
    </div>
  );
